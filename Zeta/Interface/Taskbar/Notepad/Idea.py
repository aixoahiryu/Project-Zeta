...
class Idea(Toplevel):
	def __init__(self, *args, **kwargs):
		...
		Button2(self, text='Idea', side='left', fill='both', width=55, anchor='center', relief='flat', geometry='bottom', listdir=True, path='<X>/Matter/Quick/Idea').bind("<Button-3>", lambda event: Workspace.notepadmenu.post(event.x_root, event.y_root))
