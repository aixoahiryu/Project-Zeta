...
class NotepadTask(Toplevel):
	def __init__(self, *args, **kwargs):
		...
		Button2(self, text='Task', side='left', fill='both', width=55, anchor='center', relief='flat', geometry='left', listdir=True, path='<X>/Matter/Quick/Task').bind("<Button-3>", lambda event: Workspace.notepadmenu.post(event.x_root, event.y_root))
